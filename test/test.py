...
from simple_mmseg.mmseg import Analysis

def cuttest(text, simple = True):
    wlist = [word + "/" for word in Analysis(text, simple = simple)]
    tmp = ""
    for w in wlist:
        tmp += w
    print "mmseg: ", tmp
...
if __name__=="__main__":
    cuttest(u"研究生命来源, this is a test 1988/02/29")
    cuttest(u"研究生命来源, this is a test 1988/02/29", simple = False)
    cuttest(u"中国科学院计算技术研究所")
    cuttest(u"中国科学院计算技术研究所", simple = False)
    cuttest(u"工信处女干事，this is a text.每月经过下属科室都要亲口交代24口交换机等技术性器件的安装工作")
    cuttest(u"工信处女干事，this is a text.每月经过下属科室都要亲口交代24口交换机等技术性器件的安装工作", simple = False)
